...
## If you want to run any project with .jar file then see the documentation which given jetbrains: [click link](https://www.jetbrains.com/help/idea/creating-and-running-your-first-java-application.html#run_jar_artifact)
